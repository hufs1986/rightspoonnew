...
export const RANDOM_EVENTS: RandomEvent[] = [
    {
        ...
        title: "헌재 경고",
        description: "헌법기관이 \"입법부의 사법 개입에 대해 심각한 우려\"를 표명했다",
    ...
    },
    {
        ...
        title: "국제 사회 비판",
        description: "주요 서방국가들이 \"사법 독립성 훼손 우려\"를 공식 표명했다",
        effects: { publicTrust: -8, judicialIndep: 3, mediaControversy: 10 },
        newsHeadline: "주요 서방국가 \"한국 사법독립 훼손 심각\" 공동 성명",
        minMonth: 12,
        probability: 0.12,
    },
    {
    ...
    },
    {
        ...
        title: "변호사회 긴급 성명",
        description: "변호사 단체가 \"공소취소는 법치주의 자살 행위\"라며 긴급 성명을 발표했다",
        effects: { lawRule: 6, judicialIndep: 4, mediaControversy: 8, oppositionAnger: 4 },
        newsHeadline: "변호사 단체 \"공소취소는 헌정사상 유례 없는 사법 파괴\" 긴급 성명",
        minMonth: 8,
        probability: 0.12,
    },
    {
        ...
        title: "법학 교수 청원",
        description: "전국 법학 교수 수백 명이 \"법치주의 수호\" 청원서를 헌법기관에 제출했다",
        effects: { lawRule: 4, publicTrust: -3, judicialIndep: 5 },
        newsHeadline: "법학 교수 수백 명 \"이것은 법치의 죽음\" 헌법기관 청원",
        minMonth: 10,
        probability: 0.1,
    },
    {
    ...
    },
    {
        id: "business_warning",
        title: "재계 투자 경고",
        description: "주요 경제단체가 \"사법 불확실성으로 인한 투자 위축\"을 경고했다",
        effects: { publicTrust: -6, regimeShield: -3, mediaControversy: 5 },
        newsHeadline: "경제단체 \"사법 혼란으로 외국 기업 한국 투자 보류 속출\"",
        minMonth: 12,
        probability: 0.1,
    },
    {
...
export const GAME_ENDINGS: GameEnding[] = [
    ...
    },
    {
        ...
        description: "헌법기관이 특검법 핵심 조항에 대해\n위헌 결정을 내렸습니다.\n\n공소취소 메이커는 실패했습니다.\n재판은 다시 열립니다.\n\n법치주의는 간신히 숨을 쉬었습니다.",
        emoji: "⚖️",
